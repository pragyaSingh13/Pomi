...
public class GoalItemAdapterRecent extends BaseAdapter {
    ...
    public GoalItemAdapterRecent(Context _context, List<GoalText> _goalList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = this.inflater.inflate(R.layout.goal_recent_item,
                    parent, false);
